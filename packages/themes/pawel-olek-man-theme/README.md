...
<Avatar
  theme={theme}
  size={300}
  hair="manBald"          // Choose specific hair style
...
This theme uses assets from the [`@avatune/pawel-olek-man-assets`](https://github.com/avatune/avatune/tree/main/packages/assets/pawel-olek-man-assets) package.
