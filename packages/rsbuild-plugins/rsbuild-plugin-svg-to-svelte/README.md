...
[![npm bundle size](https://img.shields.io/npm/unpacked-size/@avatune/rsbuild-plugin-svg-to-svelte)](https://www.npmjs.com/package/@avatune/rsbuild-plugin-svg-to-svelte)
