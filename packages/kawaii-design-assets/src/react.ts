...
import BodySimpleCardigan from './svg/body/simple-cardigan.svg?react'
import BodySimpleOverall from './svg/body/simple-overall.svg?react'
import BodyStriped from './svg/body/striped.svg?react'
import BodySweaterVest from './svg/body/sweater-vest.svg?react'
import BodySweaterWavy from './svg/body/sweater-wavy.svg?react'
import BodyTeeBasic from './svg/body/tee-basic.svg?react'
