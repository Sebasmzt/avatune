...
The assets are available in the [`@avatune/pawel-olek-woman-assets`](https://www.npmjs.com/package/@avatune/pawel-olek-woman-assets) package.
...
```typescript
import { hair, eyes, mouth } from '@avatune/pawel-olek-woman-assets';
```

#### React Components

```typescript
import { HairShort, EyesBoring, MouthSmile } from '@avatune/pawel-olek-woman-assets/react';
```

#### Svelte Components

```typescript
import { HairShort, EyesBoring, MouthSmile } from '@avatune/pawel-olek-woman-assets/svelte';
```

#### Vue Components

```typescript
import { HairShort, EyesBoring, MouthSmile } from '@avatune/pawel-olek-woman-assets/vue';
```
